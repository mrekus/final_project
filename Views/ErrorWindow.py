...
class ErrorWindow:
    ...
    def __init__(self, text):
        ...
        self.error_text = Label(self.frame, text=text, anchor=CENTER, font=("courier", 25, "bold"))
        self.ok_button = Button(self.frame, text="Confirm", command=self.error_window.destroy, anchor=CENTER,
                                bg="white",
                                fg="black",
